...
- public/assets/scss/layout/ecommerce/_widget.scss (legacy or global stylesheet should be reviewed before cleanup)
- public/assets/scss/layout/ecommerce/_collection.scss (legacy or global stylesheet should be reviewed before cleanup)
- public/assets/scss/layout/ecommerce/_product-3.scss (legacy or global stylesheet should be reviewed before cleanup)

## Large JS Bundles
- 164f4fb6.96b9f50d9f5f168e.js (330491 B)
- 4bd1b696-96fa2570c3ed041f.js (198840 B)
- 3794-f80d8ebc0cf4ff87.js (190763 B)
- framework-7e54adbbc2ea18ad.js (140116 B)
- main-5877a9973d65cf5f.js (130666 B)
...
- 1001-3150ecc2d2e0a6b3.js (53305 B)
- 3820-20b8e5622bbd6a9f.js (47222 B)
- 280273a7.560b210d0885bf74.js (45648 B)
- 1558-0fe1d132c7a45c29.js (40079 B)
- 8394-ab36377f905b241c.js (37856 B)
- 7537-cdb1989f262e05f8.js (31258 B)
...
- Review CSS candidate public/assets/scss/layout/ecommerce/_widget.scss (legacy or global stylesheet should be reviewed before cleanup) with safelists before any PurgeCSS apply step.
- Review CSS candidate public/assets/scss/layout/ecommerce/_collection.scss (legacy or global stylesheet should be reviewed before cleanup) with safelists before any PurgeCSS apply step.
- Review CSS candidate public/assets/scss/layout/ecommerce/_product-3.scss (legacy or global stylesheet should be reviewed before cleanup) with safelists before any PurgeCSS apply step.
...
- Review minor upgrade for knip from 5.86.0 to 5.87.0.

## Actions Requiring Human Review
- Do not auto-delete protected or business-critical file src/components/common/cart-mini-sidebar.jsx.

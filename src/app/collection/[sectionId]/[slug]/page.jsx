// app/collection/[sectionId]/[slug]/page.jsx - Dynamic Section Product Detail Page
...
export async function generateMetadata({ params }) {
  ...
  return generateSEOMetadata({
    ...
    path: `/collection/${sectionId}/${slug}`,
    ogImage: ogImageUrl,
    robots: robotsTag
  });
}
...
export default async function Page({ params }) {
  ...
  try {
    ...
    console.error('Error in collection product detail page:', error);
